...
def salvar_arquivo_planilha(planilha: pd.DataFrame, nome: str, formato: str, folder: str = '') -> None:
    ...
    def salvar() -> None:
        ...
        writer = pd.ExcelWriter(rf'{caminho_desktop}\{nome}.{_formato}', engine=f'{engine}')
